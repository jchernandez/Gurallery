...
public class ObservableGridView extends GridView implements Scrollable {
    ...
    private ObservableScrollView.ScrollState mScrollState;
            ...
            if (getChildCount() > 0) {
                ...
                if (firstVisibleChild != null) {
                    ...
                    if (mPrevScrollY < mScrollY) {
                        mScrollState = ObservableScrollView.ScrollState.UP;
                    } else if (mScrollY < mPrevScrollY) {
                        mScrollState = ObservableScrollView.ScrollState.DOWN;
                    } else {
                        mScrollState = ObservableScrollView.ScrollState.STOP;
                    }
